---
name: geo-optimizer
description: Optimize existing blog posts and web content for GEO (Generative Engine Optimization) — AI search visibility on ChatGPT, Perplexity, Claude, and Google AI Overviews. Use this skill whenever a user provides a blog URL or pastes existing content and asks to optimize it for AI search, rewrite for LLM visibility, improve GEO score, make content answer-first, add FAQ sections, restructure headings for AI retrieval, improve citation potential, or audit content for AI readiness. Also trigger when the user says "GEO optimize this", "make this AI-search ready", "rewrite for Perplexity", "optimize for ChatGPT", "improve AI visibility", "reformat for AI search", "make this content citation-worthy", "content isn't showing up in AI search", "why isn't my blog being cited by AI", "AI search audit", "GEO audit", "answer-first rewrite", "restructure for AI", "make my blog AI-friendly", "optimize for Google AI Overviews", "improve LLM citability", or shares a URL or pasted content asking why it isn't being cited or retrieved by AI engines. Do NOT trigger for requests to write new content from scratch — use geo-content for that. Always use this skill for any GEO optimization of existing content — never attempt without following this structured workflow.
---
